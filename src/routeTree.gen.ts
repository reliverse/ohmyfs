...
const FilesystemEngineRoute = FilesystemEngineRouteImport.update({
  id: '/filesystem-engine',
  path: '/filesystem-engine',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/filesystem-engine': {
      id: '/filesystem-engine'
      path: '/filesystem-engine'
      fullPath: '/filesystem-engine'
      preLoaderRoute: typeof FilesystemEngineRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/auth': {
      id: '/auth'
